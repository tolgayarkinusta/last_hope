...
def greenOnly(frame, depth, center_x, center_y, green_detected, red_detected, yellow_detected, blue_detected, black_detected, green_positions):
        ...
        if closest_center is not None:
            ...
            if closest_depth <= close_depth:
                ...
                controller.set_servo(5, backwards-40)
...
def navigate_to_start(frame, current_x, current_y, magnetic_heading, start_x, start_y):
    ...
    render_text(frame, f"Navigating home: distance = {distance:.2f} m", (frame.shape[1] - 1000, 360))
            ...
            if manual_mode:
                ...
                # Tespit durumu yoksa ve 15 saniye geçmişse 3 saniyelik süre kontrolü yap:
                    ...
                    if (current_time - start_time) >= 30 and (current_time - last_detection_time) >= 5 :
                        # Eve dönüş algoritmasının çalışması için flag kaldır:
                        itsover_flag = True
                        print("eve dönülüyor")
