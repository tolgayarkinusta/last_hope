...
engine = YOLO('yolo11xFP16.engine')
#model.to("cuda")
...
def initialize_camera():
    ...
    init_params.depth_mode = sl.DEPTH_MODE.NEURAL_PLUS # depth mode best quality at neural_plus
...
def main():
    ...
    while True:
        ...
        if zed.grab() == sl.ERROR_CODE.SUCCESS:
            ...
            results = engine.track(source=frame, save=True)
